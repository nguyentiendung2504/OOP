# ══════════════════════════════════════════════════════════════
#  Bài 2: Quản lý Nhân viên phòng ban — Inheritance + Polymorphism
# ══════════════════════════════════════════════════════════════
...
class NhanVien:
    """Lớp cha — thông tin chung của mọi nhân viên.

    Lưu ý: hệ số lương phải > 0, nếu truyền giá trị không hợp lệ
    sẽ được gán mặc định = 1.0.
    """
...
# ─────────────────────────────────────────────────────────────
#  CongTacVien: thêm thời hạn hợp đồng + phụ cấp lao động
# ─────────────────────────────────────────────────────────────
...
class NVChinhThuc(NhanVien):
    """NV chính thức — lương tính thông thường (không cộng phụ cấp).

    Không cần override tinh_luong() vì dùng đúng công thức
    của lớp cha → đây là một ưu điểm của kế thừa: không cần
    viết lại code nếu hành vi giống nhau.
    """
...
# ─────────────────────────────────────────────────────────────
#  TruongPhong: thêm ngày bắt đầu QL + phụ cấp quản lý
# ─────────────────────────────────────────────────────────────
...
# ── Minh họa Polymorphism ──────────────────────────────────
print("\n══ BẢNG LƯƠNG PHÒNG BAN (Polymorphism) ══")
ds_nv = [ctv, nvct, tp]
for nv in ds_nv:
    # Cùng gọi tinh_luong() nhưng mỗi đối tượng tính khác nhau!
